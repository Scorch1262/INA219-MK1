...
static uint16_t ina219_i2cAddress = (0x40);
...
void INA219_WriteRegister(uint8_t address, uint16_t data) {
    ...
    I2C_WriteNBytes((0x40), writeBuffer, sizeof (writeBuffer));
}

void INA219_ReadRegister(uint8_t address, uint16_t *data) {
    *data = I2C_Read2ByteRegister((0x40), address);
}
...
void INA219_setCalibration_32V_2A(void) {
    ...
    INA219_WriteRegister((0x05), ina219_calibrationValue);
    INA219_WriteRegister((0x00), (INA219_CONFIG_BVOLTAGERANGE_32V |
...
void INA219_setCalibration_16V_400mA(void) {
    ...
    ina219_powerMultiplier_mW = 1;
    INA219_WriteRegister((0x05), ina219_calibrationValue);
    INA219_WriteRegister((0x00), (INA219_CONFIG_BVOLTAGERANGE_16V |
...
int16_t INA219_getBusVoltage_raw(void) {
    int16_t value;
    INA219_ReadRegister((0x02), &value);
    return (int16_t) value;
}

int16_t INA219_getShuntVoltage_raw(void) {
    int16_t value;
    INA219_ReadRegister((0x01), &value);
    return (int16_t) value;
}

int16_t INA219_getCurrent_raw(void) {
    int16_t value;
    INA219_ReadRegister((0x04), &value);
    return (int16_t) value;
}
...
int16_t INA219_getPower_raw(void) {
    ...
    INA219_WriteRegister((0x03), &value);
    return (int16_t) value;
}
